...
function showResult(){
  ...
  if (userScore == 5){ // if user scored more than 3
      ...
      let scoreTag = '<img src="img/all_correct.png"><span>and congrats! , You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
      scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
  }
  else if(userScore == 4){ // if user scored more than 1
      let scoreTag = '<span>4<p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
      scoreText.innerHTML = scoreTag;
  }
  else if(userScore == 3){ // if user scored more than 1
    let scoreTag = '<span>3<p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
    scoreText.innerHTML = scoreTag;
}
else if(userScore == 2){ // if user scored more than 1
  let scoreTag = '<span>2<p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
  scoreText.innerHTML = scoreTag;
}
